...
model_transforms = ResNeXt101_64X4D_Weights.IMAGENET1K_V1.transforms()
...
class ResNetModule(L.LightningModule):
    def __init__(self, **kwargs):
        ...
        self.model = ResNext101(self.num_classes)
    ...
    def save_results(self):
        with open(f"results/classification/{self.aspect}/rnxt101/answers.json", "w") as wf:
