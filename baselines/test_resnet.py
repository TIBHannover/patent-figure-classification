...
def test_model(**kwargs):
    ...
    for aspect in best_model_path.keys():
        ...
        os.makedirs(f"results/classification/rn50/{aspect}", exist_ok=True)
        with open(f"results/classification/rn50/{aspect}/answers.json", "w") as wf:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="resnet50_imagenetv2")
